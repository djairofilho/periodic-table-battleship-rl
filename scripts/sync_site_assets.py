...
DEFAULT_MANIFEST = {
    ...
    "artifacts/v0.9-bayes-sampler-calibration/belief-sampler-calibration-v0.9.png": "belief-sampler-calibration-v0.9.png",
    "artifacts/v0.9-bayes-sampler-ablation/belief-sampler-ablation-v0.9.png": "belief-sampler-ablation-v0.9.png",
    "artifacts/v0.9-bayes-cross-topology-validation/smoke/paired-valid-shots-v0.9.png": "paired-valid-shots-v0.9.png",
    "artifacts/v0.9-bayesian-students/bayesian-student-v0.9-valid-shots.png": "bayesian-student-v0.9-valid-shots.png",
